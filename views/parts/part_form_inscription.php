<div class="form-mini-container">
            <form class="form-mini" method="post" action="model/dao_inscription.php" style="margin-top:100px;">
                <h1>ISCRIZIONE SOCI</h1>
                <div class="form-row">
                ...
                <div class="form-row">
                    <label>
                        <select name="tipo_socio" value="classico"  >
                            <option value="classico" >tipo di socio</option>
                            <option value="classico" >classico</option>
                            <option value="figlio">figlio</option>
                            <option value="fondatore">onorario</option>
                        </select>
                    </label>
                </div>

                 <div class="form-row">
                    <input type="number" name="numero_tessera" placeholder="N°tessera(eccezione)" >
                </div>
